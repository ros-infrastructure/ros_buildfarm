...
@(SNIPPET(
    ...
    script='\n'.join([
        ...
        '/tmp/wrapper_scripts/retry.py -- docker build -t binarydeb_task_generation__%s_%s_%s_%s_%s .' % (rosdistro_name, os_name, os_code_name, arch, pkg_name),
        'echo "# END SECTION"',
        '',
...
@(SNIPPET(
    ...
    script='\n'.join([
        ...
        '/tmp/wrapper_scripts/retry.py -- docker build -t binarydeb_build__%s_%s_%s_%s_%s .' % (rosdistro_name, os_name, os_code_name, arch, pkg_name),
        'echo "# END SECTION"',
        '',
...
@(SNIPPET(
    ...
    script='\n'.join([
        ...
        '/tmp/wrapper_scripts/retry.py -- docker build -t binarydeb_install__%s_%s_%s_%s_%s .' % (rosdistro_name, os_name, os_code_name, arch, pkg_name),
        'echo "# END SECTION"',
        '',
