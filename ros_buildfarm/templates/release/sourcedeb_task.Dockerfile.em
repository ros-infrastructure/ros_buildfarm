...
RUN python3 -u /tmp/wrapper_scripts/apt.py update-and-install -q -y debhelper dpkg dpkg-dev git git-buildpackage python3 python3-catkin-pkg python3-rosdistro python3-yaml
