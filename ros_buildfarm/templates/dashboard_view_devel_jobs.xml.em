<hudson.plugins.view.dashboard.Dashboard plugin="dashboard-view@@2.558.v96b_901978e47">
  <name>@view_name</name>
  ...
  <columns>
    ...
    <jenkins.plugins.extracolumns.BuildDescriptionColumn plugin="extra-columns@@1.28">
      <columnWidth>80</columnWidth>
      <forceWidth>true</forceWidth>
    </jenkins.plugins.extracolumns.BuildDescriptionColumn>
    <hudson.views.BuildButtonColumn/>
    <jenkins.plugins.extracolumns.TestResultColumn plugin="extra-columns@@1.28">
      <testResultFormat>1</testResultFormat>
    </jenkins.plugins.extracolumns.TestResultColumn>
    <io.jenkins.plugins.analysis.core.columns.IssuesTotalColumn plugin="warnings-ng@@13.10153.v011f47a_3ef01">
