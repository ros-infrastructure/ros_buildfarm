...
RUN python3 /tmp/auto-abi-checker/setup.py develop
# TODO enable pip3 install of auto-abi-checker. Disable the installation of python3-* packages
# RUN pip3 install -U auto-abi-checker
@[end if]@
